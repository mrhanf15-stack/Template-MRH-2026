 ...
 * jQuery in Version 3 doesn't support passive event listeners
 * this code will add it
...
function loadGallery(){
    ...
    if (total > 1){
        $('#show-next-image, #show-previous-image').click(function(){
            ...
            updateModal(selector,'image', false);
        });
    }
    function updateModal(selector,type,show) {
        var $sel = selector;
        if (type == 'image'){
            ...
            if (type == 'iframe' || src.indexOf('print') != -1 || src.indexOf('bs4_') != -1) {
    ...
    $('a.cbimages').on('click',function(){
        updateModal($(this),'image', false);
    });
    $('a.iframe').on('click',function(){
        updateModal($(this),'inline', false);
    });
    $('a.iframe_print').on('click',function(){
        updateModal($(this),'iframe', false);
    });
    $("#print_order_layer").on('submit', function(event) {
        $(this).attr('data-src',$(this).attr("action") + '&' + $(this).serialize());
        updateModal($("#print_order_layer"),'iframe', true);
        return false;
    });
}
...
$(document).ready(function(){
    ...
    $('a.iframe, a.iframe_print').each(function() {
